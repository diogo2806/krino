...
const manualSections = [
  ...
  { title: 'Campos e filtros', content: 'Unidade escolar, ano letivo e turma definem o contexto. Cada diário informa modalidade, componente curricular quando aplicável, professor responsável e vigência. Na aula, informe data, número da aula e período letivo de 1 a 4; esse período permite consolidar a frequência bimestral no Portal do Responsável.' },
  { title: 'Botões e ações', content: 'Novo diário cria o diário da turma. Abrir diário seleciona um registro. Salvar diário grava período, conteúdo e frequência. Nova avaliação cadastra avaliação; Salvar notas registra resultados. Salvar planejamento relaciona o planejamento às referências curriculares.' },
  { title: 'Regras', content: 'Aula e frequência só podem ser lançadas em dia letivo e novos lançamentos exigem período letivo de 1 a 4. Em Anos Finais e EJA, o componente deve possuir aula no horário semanal vigente. O professor precisa ter atribuição vigente e somente o professor responsável pode editar, salvo administração autorizada.' },
  ...
  { title: 'Fluxos', content: 'Selecione escola e turma, abra ou crie o diário, informe período/data/aula, registre frequência e conteúdo, cadastre avaliações e notas, mantenha o planejamento e associe referências curriculares validadas.' },
  { title: 'Mensagens e estados', content: 'A interface diferencia carregamento, ausência de diários, acesso somente para consulta, erro técnico e bloqueios de calendário, período, horário, atribuição ou responsabilidade docente.' },
];
