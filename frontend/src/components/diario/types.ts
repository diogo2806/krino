...
export type Lesson = { id: number; diaryId: number; lessonDate: string; lessonSlot: number; period?: number; content?: string; planningNotes?: string; createdBy: string; updatedBy: string; attendance: Attendance[]; };
